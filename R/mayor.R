#' Extract data of Brazilian mayoral polls.
#'
#' \code{mayor()} extracts data of Brazilian mayoral polls from the Poder
...
#'
#' @param year Election year (\code{integer}). Available years are 2000, 2004,
#'   2008, 2012 and 2016.
...
#' @export
#'
#' @return \code{data.frame} with results from polls conducted for mayoral
...
mayor <- function(year,
  ...
  banco <- extract_data_api(id = 2, year = year)
