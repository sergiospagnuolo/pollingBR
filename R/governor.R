#' Extract data of Brazilian gubernatorial polls.
#'
#' \code{governor()} extracts data of Brazilian gubernatorial polls from the
...
#'
#' @param year Election year (\code{integer}). Available years are 2002,
#'   2006, 2010, 2014, 2018.
...
governor <- function(year,
  ...
  banco <- extract_data_api(id = 1, year = year)
